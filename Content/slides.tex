...
\begin{frame}{Contemporary Approaches for Pricing}
	\onslide<+->{
		...
		\begin{itemize}[<+->]
			\item Pricing Problem (PP) in its "natural" form is NP-hard \parencite{dror1994}.
			      \begin{itemize}
				      \item \textcolor{olive}{Relaxation} of the pricing problem to make it solvable in \textcolor{blue}{pseudo-polynomial time}.
			      \end{itemize}
			\item \textbf{labeling algorithm} \parencite{desrochers1992,feillet2004}: \textcolor{blue}{dynamic programming} algorithm to solve the \textcolor{olive}{relaxed PP}.
	...
	\onslide<+->{
		...
		\begin{itemize}
			\item \textcolor{red}{\textbf{Issues with Contemporary approaches}}:
			      \begin{itemize}[<+->]
				      \item \textcolor{olive}{relaxing} the PP worsens the dual bounds fed to the BPC (increasing column generation time).
				      \item \textbf{labeling} algorithm:
				            \begin{itemize}
					            \item Its performance degrades as the \textcolor{blue}{vehicle capacity increases} (limiting its applicability).
					            \item Limited by single threaded performance.
				            \end{itemize}
			      \end{itemize}
		\end{itemize}
	}
...
\begin{frame}{Contributions}
	...
	\begin{itemize}
		\item A \textcolor{blue}{branch-and-cut} approach for the \textcolor{olive}{\textbf{non}-relaxed} pricing problem.
		      \begin{itemize}
			      \item Fixes issues described earlier.
			      \item Almost no contributions on this domain (except \parencite{jepsen2014}).
		      \end{itemize}
		\item We test its performance against state-of-the-art \textbf{labeling algorithm} as the vehicle capacity increases.
	\end{itemize}
\end{frame}
