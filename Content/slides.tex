				...
				\begin{itemize}
					\item Some implementation details:
					      \begin{itemize}
						      ...
						      \item Separation of \textcolor{blue}{cutting-planes} both for integral and fractional solutions: GSEC, RCC \parencite{laporte1983}, GLM \parencite{gouveia1995}.
						      \item Push relabel max-flow \parencite{goldberg1997} and Gomory-Hu trees \parencite{gomory1961} employed for fractional separation.
					      \end{itemize}
				\end{itemize}
			}
		\end{column}
...
\begin{frame}{History on CVRP solvers}
	\begin{itemize}
