	...
	\begin{columns}
		...
		\begin{column}{0.8\textwidth}
			\begin{itemize}
				...
				\item State-of-the-art BPC of \cite{sadykov2021bucket} developed in France at the Bordeaux University and Bordeaux Research Center.
				\item Time the labeling algorithm of \cite{pessoa2020generic} and our BAC in solving the harder PPs.
