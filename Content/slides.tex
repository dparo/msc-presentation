...
\begin{frame}{History on CVRP solvers}
	\begin{itemize}
		\item Up to late 80s: tree search algorithm with Lagrangian relaxation.
		\item 1984, 1989: First few attempts \parencite{desrosiers1984, agarwal1989setpartitioningbased} with Column Generation (unsatisfactory for CVRP).
		\item From late 80s to first 2000s: branch-and-cut approaches.
		\item 1992: labeling algorithm \cite{desrochers1992}.
