		...
		\begin{column}{0.7\textwidth}
			...
			\begin{enumerate}
				\item An exact \textcolor{blue}{branch-and-cut} algorithm for solving the \textcolor{olive}{\textbf{non}-relaxed} pricing problem.
				      ...
				      \end{itemize}
				\item We compare its competitiveness against the current \textcolor{blue}{state-of-the-art solution} \cite{pessoa2020generic} as the \textcolor{blue}{vehicle capacity increases}.
			\end{enumerate}
		\end{column}
	\end{columns}
\end{frame}
