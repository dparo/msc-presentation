...
\begin{frame}{The Pricing Sub-problem}
	The \textcolor{blue}{pricer}, a critical component in BPC frameworks, needs to solve the \textcolor{blue}{pricing sub-problem} (PP) to advance the column generation:
	\begin{itemize}
