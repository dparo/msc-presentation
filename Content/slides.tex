...
\begin{frame}{\bapcod{}}
	...
	\begin{itemize}
		...
		\item Takes as input a compact midex-integer programming model and solves it using a Dantzig-Wolfe reformulation \parencite{dantzig1960}.
		\item Sses an automatic dual price smoothing stabilization \parencite{pessoa2018automation}.
	\end{itemize}
\end{frame}
