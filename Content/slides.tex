			...
			\item \textcolor{red}{\textbf{Issues with Contemporary approaches}}:
			      \begin{enumerate}
				      \item (weak) \textcolor{olive}{relaxing} the PP worsens the dual bounds fed to the BPC (increasing column generation time).
				            ...
				            \end{itemize}
				      \item (strong) \textbf{Labeling} algorithm's performance degrades as the \textcolor{blue}{vehicle capacity increases}, limiting its applicability to modern distribution problems.
			      \end{enumerate}
		\end{itemize}
	}
\end{frame}
